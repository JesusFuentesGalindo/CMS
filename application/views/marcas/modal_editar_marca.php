                ...
                <form id="frm_edit_brand" class="needs-validation" novalidate>
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label for="brand_edit_txt_name">Nombre</label>
                        ...
                        <div class="form-group">
                            <label for="brand_edit_txt_description">Descripción</label>
                            <textarea id="brand_edit_txt_description" class="form-control"></textarea>
                            <div class="valid-feedback">
                        ...
                        <!--Equipos de la Marca------------------------------------>
                        <div class="form-group">
                            <label for="brand_edit_txt_equipments">Equipos</label>
                            <textarea id="brand_edit_txt_equipments" class="form-control"></textarea>
                            <div class="valid-feedback">
                                ¡Equipos validado!
                            </div>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            <label for="brand_edit_txt_aplication">Aplicación</label>
                            <textarea id="brand_edit_txt_aplication" class="form-control"></textarea>
                            <div class="valid-feedback">
                                ¡Aplicación validado!
                            </div>
                            <div class="invalid-feedback">
